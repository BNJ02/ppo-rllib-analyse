...
La version longue du [résumé](00-resume-papier-ppo.md) : la chaîne complète $`\hat g \to L^{CPI} \to`$ contrainte TRPO $`\to L^{CLIP}`$, déroulée sans raccourci.
...
| La version courte, en une page | [00-resume-papier-ppo.md](00-resume-papier-ppo.md) |
